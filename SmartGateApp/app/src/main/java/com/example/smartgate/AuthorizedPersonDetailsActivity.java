...
public class AuthorizedPersonDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        authPersonImage = (ImageView)findViewById(R.id.product_image_Adetails);
        LPNumber = (TextView) findViewById(R.id.lp_number_details);


        new FirebaseAuthorizedPersonHelper().readOneAuthPerson(IDNumberS, new FirebaseAuthorizedPersonHelper.DataStatus() {
            @Override
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder1.setMessage("האם אתה בטוח שברצונך למחוק את הכרטיס ? ");
                ...
                builder1.setPositiveButton(
                        ...
                        new DialogInterface.OnClickListener() {
                            public void onClick( final DialogInterface dialog, int id) {
                                ...
                                new FirebaseAuthorizedPersonHelper().deleteAuthPerson(IDNumberS, new FirebaseAuthorizedPersonHelper.DataStatus() {
                                    @Override
                                ...
                                new FirebasePlacesHelper().deleteAuthPerson(authorizedPerson, new FirebasePlacesHelper.DataStatus() {
                                    @Override
